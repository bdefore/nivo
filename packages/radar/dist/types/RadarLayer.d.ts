...
export declare const RadarLayer: <D extends Record<string, unknown>>({ data, item: key, colorByKey, fillByKey, radiusScale, angleStep, curveFactory, borderWidth, borderColor, fillOpacity, blendMode, }: RadarLayerProps<D>) => JSX.Element;
export {};
