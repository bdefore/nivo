...
export declare type FunnelDirection = 'horizontal' | 'vertical';
export declare type FunnelAreaPoint = BoxPosition;
export declare type FunnelAreaGenerator = Area<FunnelAreaPoint>;
export declare type FunnelBorderGenerator = Line<Position | null>;
...
export declare type FunnelPartEventHandler<D extends FunnelDatum> = (part: FunnelPart<D>, event: MouseEvent) => void;
...
export declare type FunnelLayerId = 'separators' | 'parts' | 'labels' | 'annotations';
...
export declare type FunnelCustomLayer<D extends FunnelDatum> = FunctionComponent<FunnelCustomLayerProps<D>>;
...
export declare type FunnelSvgProps<D extends FunnelDatum> = Partial<FunnelCommonProps<D>> & FunnelDataProps<D> & Dimensions & ModernMotionProps;
