...
import { Theme, Box, Dimensions, ModernMotionProps, PropertyAccessor, ValueFormat, SvgDefsAndFill } from '@nivo/core';
...
export declare type RadialBarLayerId = 'grid' | 'tracks' | 'bars' | 'labels' | 'legends';
...
export declare type RadialBarCustomLayer = FunctionComponent<RadialBarCustomLayerProps>;
export interface RadialBarTooltipProps<D extends RadialBarDatum = RadialBarDatum> {
    bar: ComputedBar<D>;
}
export declare type RadialBarTooltipComponent = FunctionComponent<RadialBarTooltipProps>;
export interface RadialBarTrackDatum {
    id: string;
    color: string;
    arc: Arc;
}
export declare type RadialBarCommonProps<D extends RadialBarDatum = RadialBarDatum> = {
...
export declare type RadialBarSvgProps<D extends RadialBarDatum = RadialBarDatum> = Partial<RadialBarCommonProps<D>> & RadialBarDataProps<D> & Dimensions & ModernMotionProps & SvgDefsAndFill<D>;
