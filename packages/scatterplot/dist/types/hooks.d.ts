...
export declare const useScatterPlot: <RawDatum extends ScatterPlotDatum>({ data, xScaleSpec, xFormat, yScaleSpec, yFormat, width, height, nodeId, nodeSize, colors, }: {
    ...
    xScale: import("@nivo/scales").ScaleSymlog | import("d3-scale").ScaleLogarithmic<number, number, never> | import("@nivo/scales").ScaleLinear<number> | import("@nivo/scales").ScaleTime<Date | import("d3-scale").NumberValue> | import("@nivo/scales").ScalePoint<RawDatum["x"]> | import("@nivo/scales").ScaleBand<RawDatum["x"]>;
    yScale: import("@nivo/scales").ScaleSymlog | import("d3-scale").ScaleLogarithmic<number, number, never> | import("@nivo/scales").ScaleLinear<number> | import("@nivo/scales").ScaleTime<Date | import("d3-scale").NumberValue> | import("@nivo/scales").ScalePoint<RawDatum["y"]> | import("@nivo/scales").ScaleBand<RawDatum["y"]>;
